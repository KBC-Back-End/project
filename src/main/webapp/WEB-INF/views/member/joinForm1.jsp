...
<h2>개인정보 수집 및 이용동의</h2>
	...
	<form action="/member/joinForm2" method="get">
	<table>
	<tr>
	<td>이용약관</td>
		<td><textarea rows="20" cols="150">
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.
		...
		<tr>
		<td><label> <input type="checkbox" class="chk" >동의</label></td>
		
		</tr>
			</table>
			
		    <input type="submit" value="다음단계" class="nextBtn" disabled>
	</form>
</div>
</div>
