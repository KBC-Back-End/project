...
<form action="/dpm/departmentNameList" class="search_area" method="post">
학과명 : <input name="keywordName" value="${page.cri.keywordName}">
...
$(".pageInfo a").on("click", function(e){
	...
	moveForm.attr("action", "/dpm/departmentNameList");
	moveForm.submit();
});	
</script>             
